...
define('TEXT_COUPON_ANNOUNCE','Annamme sinulle alennuskuponki verkkokauppaamme, olkaa hyvä!');
...
define('TEXT_VISIT', 'Vieraille verkkokaupassamme osoitteessa %s');
define('TEXT_COUPON_HELP_DATE', '<p>Kuponki on voimassa %s - %s</p>');
define('HTML_COUPON_HELP_DATE', '<p>Kuponki on voimassa %s - %s</p>');
...
define('COUPON_FREE_SHIP_HELP', 'Kuponki oikeuttaa ilmaiseen kuljetukseen.');
...
define('COUPON_SALE_HELP', 'Jos valitset <i>EI sallittu</i>, myytäviä tai erikoistuotteita ei alenneta tai lasketa mukaan kuponin vähimmäistilaukseen.');
...
define('ERROR_NO_COUPONS', 'Ei kuponkeja');