...
//
define ('BOX_TOOLS_DISPLAY_LOGS', 'Näytä lokitiedostot ');
...
//
define ('DISPLAY_LOGS_MESSAGE_LOGS_PRESENT', '%1$u virheenkorjauslokitiedostot ovat olemassa , <a href="%2$s">here</a> katso.');