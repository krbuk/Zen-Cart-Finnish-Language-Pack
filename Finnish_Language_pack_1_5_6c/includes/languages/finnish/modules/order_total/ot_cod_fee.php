...
// Finnish translation by JNT Finland Oy (Pasi Rajala) <pasi.rajala@jnt-finland.fi>
  define('MODULE_ORDER_TOTAL_COD_TITLE', 'Jälkivaatimus');
  define('MODULE_ORDER_TOTAL_COD_DESCRIPTION', 'Jälkivaatimus');
  define('TEXT_INFO_COD_FEES', '<strong>Huomio:</strong> Jälkivaatimus käytössä');
?>