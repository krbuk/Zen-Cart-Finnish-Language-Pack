...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Luo tili');
define('BUTTON_LOG_OFF_ALT', 'Kirjaudu ulos');
define('BUTTON_ADD_TO_CART_ALT', 'Lisää ostoskoriin');
define('BUTTON_ADD_ADDRESS_ALT', 'Lisää osoite');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Lisää valitut tuotteet ostoskoriin');
define('BUTTON_BACK_ALT', 'Takaisin');
define('BUTTON_BUY_NOW_ALT', 'Osta heti');
define('BUTTON_CANCEL_ALT', 'Peruuta');
define('BUTTON_CHANGE_ADDRESS_ALT', 'Muuta osoitetta');
define('BUTTON_CHECKOUT_ALT', 'Kassa');
define('BUTTON_CONFIRM_SEND_ALT', 'Lähetä lahjakortti');
define('BUTTON_CONFIRM_ORDER_ALT', 'Vahvista tilaus');
define('BUTTON_CONTACT_US_TEXT', 'Ota yhteyttä');
define('BUTTON_CONTINUE_ALT', 'Jatka');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Jatka ostostentekoa');
define('BUTTON_DELETE_ALT', 'Poista');
define('BUTTON_DELETE_SMALL_ALT', 'Poista');
define('BUTTON_DOWNLOAD_ALT', 'Lataa nyt');
define('BUTTON_EDIT_SMALL_ALT', 'Muokkaa');
define('BUTTON_IN_CART_ALT', 'Lisää ostoskoriin');
define('BUTTON_LOGIN_ALT', 'Kirjaudu sisään');
define('BUTTON_LOOKUP_ALT', 'Katso ylös');
define('BUTTON_MY_ACCOUNT_TEXT', 'Tilini');
define('BUTTON_MY_ORDERS_TEXT', 'Tilaukseni');
define('BUTTON_NEXT_ALT', 'Seuraava');
define('BUTTON_PREVIOUS_ALT', 'Edellinen');
define('BUTTON_REDEEM_ALT', 'Lunasta');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Palaa tuotelistaan');
define('BUTTON_REVIEWS_ALT', 'Mene arvostelusivuille');
define('BUTTON_SEARCH_ALT', 'Etsi');
define('BUTTON_SEND_ALT', 'Lähetä nyt');
define('BUTTON_SEND_ANOTHER_ALT', 'Lähetä toinen lahjakortti');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Lähetä lahjakortti');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Toimituskululaskuri');
define('BUTTON_SOLD_OUT_ALT', 'Loppuunmyyty');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Loppuunmyyty');
define('BUTTON_SUBMIT_ALT', 'Lähetä tiedot');
define('BUTTON_UNSUBSCRIBE', 'Poista tilaus');
define('BUTTON_UPDATE_ALT', 'Päivitä');
define('BUTTON_VIEW_SMALL_ALT', 'Avaa');
define('BUTTON_WRITE_REVIEW_ALT', 'Kirjoita arvostelu');
define('BUTTON_READ_REVIEWS_ALT', 'Lue arvostelut');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Näytä tämän tuotteen tarkemmat tiedot');
define('BUTTON_MORE_REVIEWS_ALT', 'Lue lisää arvosteluja');
define('BUTTON_VIEW_ALL_ALT', 'Näytä kaikki');
?>