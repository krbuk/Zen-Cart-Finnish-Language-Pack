...
define('NAVBAR_TITLE', 'Usein kysyttyä ' . TEXT_GV_NAMES . 'eista');
define('HEADING_TITLE', 'Usein kysyttyä ' . TEXT_GV_NAMES . 'eista');
...
define('SUB_HEADING_TEXT', TEXT_GV_NAMES . 'in ostaminen tapahtuu samalla tavalla kuin minkä tahansa muun tuotteen ja voit maksaa
  sen kauppamme hyväksymillä maksutavoilla.   Kun olet ostanut ' . TEXT_GV_NAMES . 'in, sen arvo siirtyy sinun henkilökohtaiselle
   ' . TEXT_GV_NAME . 'tilillesi. Jos sinulla on rahaa ' . TEXT_GV_NAME . 'tililläsi, näkyy kyseinen summa ostoskori ikkunassa
  jossa on myös linkki jota painamalla voit lähettää ' . TEXT_GV_NAMES . 'in sähköpostilla.<br><br><a href="index.php?main_page=index&cPath=15">' .BOX_HEADING_GIFT_CERTIFICATE .'</a>');
  break;
  case '2':
