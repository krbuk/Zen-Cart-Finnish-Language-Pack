...
define('TABLE_HEADING_BANNER_ON_SSL', 'Näytä SSL-suojatussa tilassa');
...
define('ERROR_IMAGE_DIRECTORY_DOES_NOT_EXIST', 'Virhe: Kohdehakemistoa ei ole olemassa: %s');
define('ERROR_IMAGE_DIRECTORY_NOT_WRITEABLE', 'Virhe: Kohdehakemistoon ei voitu kirjoittaa: %s');
