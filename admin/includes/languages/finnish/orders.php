...
define('HEADING_TITLE_DETAILS', 'Tilauksen tiedot');
define('HEADING_TITLE_SEARCH', 'Tilausnumero:');
define('HEADING_TITLE_STATUS', 'Tila:');
define('HEADING_TITLE_SEARCH_DETAIL_ORDERS_PRODUCTS', 'Etsi tuotteen nimellä tai <strong>ID:XX</strong> tai koodilla ');
...
define('TEXT_INFO_SEARCH_DETAIL_FILTER_ORDERS_PRODUCTS', 'Hakusuodatin: ');
...
define('ENTRY_DELIVERY_TO', 'Toimitusosoite:');
...
define('TEXT_PAID', 'Maksettu');
define('TEXT_UNPAID', 'Ei maksettu');
...
define('ENTRY_ORDER_ID','Laskunnmero: ');
