...
define('TEXT_INFO_AVAILABLE_DATE', 'Voimassa alkaen:');
...
define('TEXT_INFO_DELETE_INTRO', 'Haluatko varmasti poistaa tuotteen esittelystä?');
  ...
  define('TEXT_PRICED_BY_ATTRIBUTES', 'Hinnoiteltu ominaisuuksilla');
  define('TEXT_PRODUCTS_PRICE', 'Tuotteen hinta: ');
  define('TEXT_SPECIAL_PRICE', 'Tarjoushinta: ');
  define('TEXT_SALE_PRICE', 'Ale hinta: ');
...
define('TEXT_PRODUCTS_DISCOUNT_TYPE','Tyyppi');
...
define('TEXT_EACH','kpl');
define('TEXT_EXTENDED','yhteensä');
...
define('TEXT_INFO_MASTER_CATEGORIES_CURRENT', ' Nykyinen ryhmä ID# %s täsmää tuotteen todelliseen ryhmään ID# %s');
...
define('BUTTON_ADDITITONAL_ACTIONS', 'Lisätoimia');
?>